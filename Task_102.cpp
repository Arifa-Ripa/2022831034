...
bool initialization(){
    ...
    Window = SDL_CreateWindow ("Increasing Circle radius", SDL_WINDOWPOS_UNDEFINED , SDL_WINDOWPOS_UNDEFINED , SCREEN_HEIGHT , SCREEN_WIDTH , SDL_WINDOW_SHOWN);
...
int main(int argc, char* argv[]){
    ...
    while(!quit){
        ...
        if(Radius>(SCREEN_HEIGHT)/2 || Radius>(SCREEN_WIDTH)/2){
            Radius=50;
        }
